...
import com.shop.Daoo.BillDAO;
import com.shop.Daoo.BillDetailDAO;
...
public class BillJDialog extends javax.swing.JDialog implements BillController {
    ...
    public void showDrinkJDialog() {
        ...
        ShopJDialog dialog = new ShopJDialog((Frame) this.getOwner(), true);
    ...
    private void initComponents() {
        ...
        tblBillDetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Mã phiếu", "Loại ", "Đơn giá", "Giảm giá", "Số lượng", "Thành tiền"
            }
        ) {
