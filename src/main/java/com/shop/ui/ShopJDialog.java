 ...
 * @author DELL
 */
public class ShopJDialog extends javax.swing.JDialog implements ShopController {

    /**
     * Creates new form AddDrinkToBillJDialog
     */
    public ShopJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShopJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ShopJDialog dialog = new ShopJDialog(new javax.swing.JFrame(), true);
